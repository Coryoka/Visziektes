 ...
 */
public class FilterToevoegenController implements Initializable {
    ...
    public FilterToevoegenController(int aquariumID) {
        ...
        ButtonSave.setOnAction(new EventHandler<ActionEvent>() {
            ...
            public void handle(ActionEvent event) {
                try {
                    ...
                    aquariumDAO.InsertFilter(aquariumID,naamApparaat.getText(),Installatiedag,LaatstSchoongemaaktDag);
